...
home.hears(/\/register/, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
home.action('view', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var messages, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, ctx.telegram.copyMessage(ctx.update["callback_query"].from.id, messages[i].chat.id, messages[i].message_id)];
            case 4:
                _a.sent();
                _a.label = 5;
            case 5:
