...
moderation.enter(function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(ctx.updateType == 'callback_query')) return [3 /*break*/, 2];
                return [4 /*yield*/, ctx.editMessageText('Модерация')];
            case 1:
                _a.sent();
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, ctx.reply('Модерация')];
            case 3:
                _a.sent();
                _a.label = 4;
